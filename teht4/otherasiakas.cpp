#include "otherasiakas.h"

OtherAsiakas::OtherAsiakas(string n, double d):kayttotili(n),luottotili(n,d)
{
    nimi = n;
    cout<<"Asiakkuus luotu "<<n<<":lle"<<endl;
}

string OtherAsiakas::getNimi()
{
 return nimi;
}

void OtherAsiakas::showSaldo()
{
...
bool OtherAsiakas::talletus(double d)
{
...
bool OtherAsiakas::nosto(double d)
{
...
bool OtherAsiakas::luotonMaksu(double d)
{
...
bool OtherAsiakas::luotonNosto(double d)
{
